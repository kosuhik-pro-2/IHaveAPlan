...
const HeaderThree = () => {
   ...
   return (
      <>
         <header>
            <div id="header-sticky" className={`td-header__area td-header-sticky-white td-header-spacing td-header-2-wrapper td-header-3-wrapper p-relative z-index-1 ${sticky ? "header-sticky" : ""}`}>
               <div className="container">
                  <div className="row align-items-center">
                     <div className="col-xl-2 col-4">
                        <div className="logo">
                           <Link className="logo-1" to="/"><img data-width="96" src="/assets/img/logo/logo-white-black.png" alt="Logo" /></Link>
                     ...
                     <div className="col-xl-3 col-8">
                        <div className="td-header-right text-end">
                           ...
                           <div className="d-inline-block ml-20">
                              <div className="tdmenu-offcanvas-open-btn d-xl-none mobile-nav-toggler d-flex align-items-center justify-content-center">
