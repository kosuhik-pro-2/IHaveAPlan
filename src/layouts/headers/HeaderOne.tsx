...
const HeaderOne = () => {
   ...
   return (
      <>
         <header>
            <div id="header-sticky" className={`td-header__area td-header-spacing p-relative z-index-1 ${sticky ? "header-sticky" : ""}`}>
                        ...
                        <div className="td-header-right text-end">
                           <button onClick={() => setIsSearch(true)} className="td-header-search search-open-btn">
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M9.00004 17.0001C13.4183 17.0001 17.0001 13.4183 17.0001 9.00004C17.0001 4.58174 13.4183 1 9.00004 1C4.58174 1 1 4.58174 1 9.00004C1 13.4183 4.58174 17.0001 9.00004 17.0001Z" stroke="#1C1D1F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                 <path d="M19.0004 18.9999L14.6504 14.6499" stroke="#1C1D1F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                              </svg>
                           </button>
