...
const ShopArea = () => {
   ...
   return (
      <div className="td-shop-area pt-155 pb-110">
         <div className="container-fluid container-1710">
            <div className="row">
               ...
               <div className="col-xxl-10 col-xl-9 col-lg-8">
                  <div className="td-shop-sidebar-wrap mb-50">
                     <ShopTop
                     ...
                     />
                     <div className="td-shop-main-wrap">
                        <div className="row">
                           {currentItems.map((item) => (
                              <div key={item.id} className="col-xxl-4 col-xl-6 col-lg-6 col-md-6 mb-40">
                                 <div className="td-product-item">
                                    <div className="td-product-thumb mb-10 fix p-relative">
                                       <div className="p-relative">
                                          <Link to="/shop-details">
                                             <img className="w-100" src={item.thumb} alt="product" />
                                          </Link>
                                          <div className="td-product-btn">
                                             <Link to="/shop-details">SHOP NOW</Link>
                                          </div>
                                       </div>
                                       <div className="td-product-action">
                                          <div className="td-product-action-item">
                                             <button type="button" className="td-product-action-btn td-product-add-cart-btn">
                                                ...
                                                <span className="td-product-tooltip">Add to Cart</span>
                                             </button>
                                             <button type="button" className="td-product-action-btn td-product-quick-view-btn" data-bs-toggle="modal" data-bs-target="#producQuickViewModal">
                                                ...
                                                <span className="td-product-tooltip">Quick View</span>
                                             </button>
                                             <button type="button" className="td-product-action-btn td-product-add-to-wishlist-btn">
                                                ...
                                                <span className="td-product-tooltip">Add To Wishlist</span>
                                             </button>
                                          </div>
                                       </div>
                                    </div>
                                    <div className="td-product-content d-flex justify-content-between align-items-center">
                                       <div className="td-product-category-wrap">
                                          <span className="td-product-category">{item.category}</span>
                                          <h5 className="td-product-title"><Link to="/shop-details">{item.title}</Link></h5>
                                       </div>
                                       <div className="td-product-price-wrap">
                                          <span className="td-product-price">${item.price}</span>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div className="col-lg-12">
                              <div className="td-blog-pagenation justify-content-center d-flex mt-45">
                                 <ReactPaginate
                                    breakLabel="..."
