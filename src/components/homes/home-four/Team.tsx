...
const Team = () => {
   ...
   return (
      <div className="td-team-area pt-110">
         <div className="container-fluid">
            <div className="row">
               <div className="col-xxl-6 col-xl-7 offset-xxl-4 offset-xl-3">
                  <div className="td-team-4-title-wrap d-inline-block mb-55">
                     <h2 className="td-section-4-title mb-0 fw-600">LET’S TALK WITH</h2>
                     <h2 className="td-section-4-title second fw-600">OUR <span className="green-text">EXPERTS</span></h2>
                  </div>
               </div>
            </div>
            <div className="row">
                  ...
                  <div key={item.id} className="col-lg-3 col-md-6 col-sm-6">
                     <div className="td-team-4-wrap p-relative mb-30">
                        ...
                        <div className="td-team-4-content text-center">
                           ...
                           <h3 className="td-team-4-title"><Link to="/team-details">{item.name}</Link></h3>
               ...
               <div className="col-12">
                  <div className="text-center mt-45">
                     <Link to="/team" className="td-btn td-btn-4 td-btn-4-lg d-none d-md-inline-block td-btn-switch-animation">
